  ...
  return (
    <section className="min-h-screen py-20 flex flex-col items-center justify-center relative">
      <div className="text-center w-full px-4">
        <h1 className="md:text-3xl lg:text-[2.75rem] text-white mb-6 leading-tight animate-float-slow font-pixel tracking-tight text-center whitespace-nowrap sm:text-3xl text-[3.8vw]" style={{ textShadow: '0px 2px 12px rgba(0,0,0,0.75)' }}>
