  ...
  return (
    <section className="min-h-screen py-20 flex flex-col items-center justify-center relative">
      <div className="text-center max-w-3xl">
        <h1 className="md:text-5xl lg:text-6xl text-white mb-6 leading-tight text-4xl animate-float-slow font-extrabold tracking-tight" style={{ fontFamily: "'Inter', sans-serif", textShadow: '0px 2px 12px rgba(0,0,0,0.75)' }}>
          Abhiram Vedipala
        </h1>
        <p className="md:text-lg mb-4 text-white/90 text-base font-semibold tracking-wide uppercase" style={{ fontFamily: "'Inter', sans-serif", textShadow: '0px 2px 12px rgba(0,0,0,0.75)' }}>
